...
public class SubtaskResults {
    ...
    private SubtaskCapability capability;
    ...
    public  SubtaskResults(Subtask j, HashMap<AbstractAgent, IterationResults> ccbbaResults, HashMap<Task, TaskCapability> capabilities){
        IterationResults results = null;
        for(AbstractAgent agent : ccbbaResults.keySet()){
            results = ccbbaResults.get(agent);
        }
